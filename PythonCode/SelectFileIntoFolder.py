#this code doesn't contain Facial Recognition related functionalities
#this code only allows your to import images/faces into your preferred folder or (local database)
from tkinter import *
...
class Root(Tk):
    def __init__(self):
        ...
        self.title("Oreoulwa's Facial Recognition DoorLock")
